...
function ENT:Think()
	...
	local flame2 = self.Emitter:Add("effects/energyball", self:GetPos())
	if flame2 then
		flame2:SetVelocity(self.FlameDir * math.random(40, 50))
		flame2:SetGravity(-GRAV_SPARKS / 5)

		flame2:SetDieTime(0.9)
		flame2:SetColor(math.random(80, 120), math.random(80, 120), 0)

		flame2:SetStartAlpha(200)
		flame2:SetEndAlpha(1)

		flame2:SetStartSize(2)
		flame2:SetEndSize(5)
	end
